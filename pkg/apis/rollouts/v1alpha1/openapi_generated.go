		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"requestTimeout": {
						SchemaProps: spec.SchemaProps{
							Description: "RequestTimeout overrides the HTTP client timeout for requests to the Datadog API (e.g. 10s, 30s; default: 10s).",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_pkg_apis_rollouts_v1alpha1_PrometheusMetric(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"rangeQuery": {
						SchemaProps: spec.SchemaProps{
							Description: "Arguments for prometheus",
		...
		Dependencies: []string{
			"github.com/argoproj/argo-rollouts/pkg/apis/rollouts/v1alpha1.Authentication", "github.com/argoproj/argo-rollouts/pkg/apis/rollouts/v1alpha1.PrometheusRangeQueryArgs", "github.com/argoproj/argo-rollouts/pkg/apis/rollouts/v1alpha1.WebMetricHeader"},
	}
}

func schema_pkg_apis_rollouts_v1alpha1_PrometheusRangeQueryArgs(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"reason": {
						SchemaProps: spec.SchemaProps{
							Description: "Reason is a brief explanation for the condition's last transition",
							Type:        []string{"string"},
							Format:      "",
						},
					},
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"strategy": {
						SchemaProps: spec.SchemaProps{
							Description: "Strategy defines the deployment strategy",
							Default:     map[string]interface{}{},
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"phase": {
						SchemaProps: spec.SchemaProps{
							Description: "Phase is the current phase of the rollout",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					...
					"pauseConditions": {
						SchemaProps: spec.SchemaProps{
							Description: "PauseConditions is a list of reasons why rolloutplugin became automatically paused (e.g. CanaryPauseStep). The items in this list are populated by the controller but are cleared by the user (e.g. ArgoCD resume action, kubectl patch) when they wish to unpause. If pause conditions is empty, but controllerPause is true, it indicates the user manually unpaused the RolloutPlugin",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"controllerPause": {
						SchemaProps: spec.SchemaProps{
							Description: "ControllerPause indicates the controller has paused the rolloutplugin. It is set to true when the controller adds a pause condition. This field helps to discern the scenario where a rolloutplugin was resumed after being paused by the controller (e.g. via ArgoCD resume action). In that situation, the pauseConditions would have been cleared, but controllerPause would still be set to true.",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
					"aborted": {
						SchemaProps: spec.SchemaProps{
							Description: "Aborted indicates whether the rolloutplugin has been aborted",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
					...
					"abort": {
						SchemaProps: spec.SchemaProps{
							Description: "Abort will stop the rolloutplugin and revert to the previous version when set to true.",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
					...
					"restartCount": {
						SchemaProps: spec.SchemaProps{
							Description: "RestartCount tracks the number of restart attempts for the current rollout Incremented each time Restart is processed Reset to 0 when a new rollout starts",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					...
					"abortedAt": {
						SchemaProps: spec.SchemaProps{
							Description: "AbortedAt indicates when the rollout was aborted",
							Ref:         ref("k8s.io/apimachinery/pkg/apis/meta/v1.Time"),
						},
					},
				},
